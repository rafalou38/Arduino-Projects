...
void setup()
{
    ...
    {                                             // Look EEPROM if Master Card defined, EEPROM address 1 holds if defined
        ...
        lcd.clear();
        lcd.setCursor(0, 0);
        lcd.println("SCAN MASTER   "); // When no Master Card in Your EEROM (LCD Display)
        lcd.setCursor(0, 1);
        lcd.println("SCAN A KEYCARD"); // Scan any RFID CARD to set Your Master Card in Your EEROM (LCD Display)
        delay(1500);
        do
        {
